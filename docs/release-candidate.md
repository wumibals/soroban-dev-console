...
|-----|-------------------|
| `devops` | Runtime-port drift (`check-drift`), lockfile/workspace integrity (`check-integrity`), dead-letter handling validation, failover drill check, backup integrity verification, staging parity validation |
